...
RUN apk add --no-cache bash coreutils build-base gcompat libstdc++ gcc musl-dev curl wget python3 python3-dev py3-pip pipx libffi-dev libressl libffi-dev libressl-dev libxslt-dev libxml2-dev=2.9.14-r2 libxml2 jq aws-cli
